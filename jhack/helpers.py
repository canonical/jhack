...
def get_app_metadata(app_name: str, app_meta, model: Optional[str] = None):
    """Fetch metadata yaml from any unit of this application."""
    is_subordinate = app_meta.get("subordinate-to")
    if is_subordinate:
