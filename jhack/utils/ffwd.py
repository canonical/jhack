...
def fast_forward(
    timeout: int = typer.Option(
        None,
        help="Time after which ffwd will automatically stop. "
        "If unfilled, it will continue until CTRL+C.",
    ),
    fast_interval: int = typer.Option(5, help="Time in seconds for the speed up."),
    slow_interval: str = typer.Option(
        "5m",
        help="Time (as a string) at which the speed will be reset"
